        ...
        if (length && length > 2 && data[0] == '4' && data[1] == '2') {
            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    //either we will reference the starting point as wgere the car is or at the previous paths end point
                    double ref_x = car_x;
                    double ref_y = car_y;
                    double ref_yaw = deg2rad(car_yaw);
                    
                    
                    //if the prev size is almost empty us ethe car as satrting referece
                    ...
                    if(prev_size < 2)
                    {
                        ...
                        //use the previous paths end point as starting referece
                        
                        //Redefine ref state as previous path end poibts
                        //use last 2 points
                    ...
                    //Define actual (x,y) points ww will use for the planner
                    ...
                    //calculate how to break up spline points so that we cab travel at our desired reference velocity
                    double target_x = 30;
